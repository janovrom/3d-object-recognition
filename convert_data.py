...
if __name__ == '__main__':
    ...
    create_segmentation_set("D:/janovrom/Data/test-data-out", "./ModelNet-data-64/test", grid_size=64)
    create_segmentation_set("D:/janovrom/Data/train-data-out", "./ModelNet-data-64/train", grid_size=64)
