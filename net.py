...
if __name__ == "__main__":
    ...
    model = Net3D("Net3D-engine", "./3d-object-recognition/Engine-data")
    model.run_model(print_cost=True, load=False, train=True, show_activations=False, save_misclass=True)
